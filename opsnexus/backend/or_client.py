...
class OpenRouterClient:
    ...
    def __init__(self) -> None:
        ...
        self._headers = {
            ...
            "HTTP-Referer":  "https://github.com/aayam-jarvis",
            "X-Title":       "AAYAM JARVIS",
        }
    ...
    def chat(
        ...
        prompt: str,
        system: str = (
            "You are a component of AAYAM JARVIS, an AI assistant inspired by JARVIS. "
...
if __name__ == "__main__":
    print("=" * 55)
    print("  AAYAM JARVIS — OpenRouter Client Self-Test")
    print("=" * 55)
